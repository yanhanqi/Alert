...
class MaskedLangModelingSequenceCollate(BaseSequenceCollate):
    ...
    def __call__(
        ...
        # The index tensor of target tokens is returned separately instead of
        # being stored in the TensorDict, because its [2, n_targets] shape does
        # not match the batch size and newer tensordict versions reject it.
